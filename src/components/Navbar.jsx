...
export default function Navbar() {
  ...
  return (
    ...
    <>
      ...
      <nav className={`fixed top-0 left-0 w-full flex items-center justify-between px-8 py-4 z-50 transition-transform duration-300 ${visible ? "translate-y-0" : "-translate-y-full"}`}>
        <div className="text-2xl font-bold text-white hidden sm:block">
          <span className="text-3xl">K</span>etan
        </div>
